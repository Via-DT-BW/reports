...
class PDF(FPDF):
    def header(self):
        ...
        self.set_text_color(0, 56, 108)
        
        self.image('logo.png', x=20, y=13, w=40)
        
        self.cell(0, 10, 'Check List de Avaliação Prática Nível B-C1', 0, 1, 'R')
    ...
    def footer(self):
        ...
        self.set_font('Arial', 'B', 12)
        self.set_text_color(0, 56, 108)
        self.cell(0, 15, 'DT.18.1.4.2', 0, 1, 'C')
...
def create_pdf(user_info, responses):
    ...
    pdf.output('avaliacao_pratica2.pdf')
